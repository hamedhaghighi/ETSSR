...
class RSTB(nn.Module):
    ...
    def forward(self, x, x_size):
        ...
        out = out.transpose(1, 2).view(-1, self.dim, x_size[0], x_size[1])
        out = self.conv(out)
...
class SwinIR(nn.Module):
    ...
    def __init__(self, img_size=64, patch_size=1, in_chans=3,
        ...
        self.patches_resolution = [img_size[0], img_size[1]]
...
if __name__ == '__main__':
    ...
    model = SwinIR(upscale=2, img_size=(height, width), window_size=window_size, img_range=1., depths=[6, 6, 6, 6], embed_dim=60, num_heads=[6, 6, 6, 6], mlp_ratio=2, upsampler='pixelshuffledirect')
