                ...
                for idx in range(len(test_set)):
                    ...
                    if data_idx in indices_to_save[env] or cfg.metric_for_all:
                        ...
                        if not 'bicubic' in cfg.model:
                            ...
                            sr_left, sr_right = sr_left[:cfg.scale_factor * cfg.input_resolution[0], :cfg.scale_factor * cfg.input_resolution[1]], sr_right[:cfg.scale_factor * cfg.input_resolution[0], :cfg.scale_factor * cfg.input_resolution[1]]
                        else:
